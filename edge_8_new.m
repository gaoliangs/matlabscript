result_edge = zeros(12,7);
%%%%%%%%%%%%%%%%t1,t2,t3,c3
%edge1 F_0_0_c3=F;
if result_corner(1,1)>=result_corner(5,1)
%if F_0_0_0>=F_0_0_1
    l0 = subs(l_c,[t1,t2,t3,c1,c2,c3],[result_corner(1,2:4),0,0,x]);
	check_c0
	if dFcx>0
        [t1_v,t2_v,t3_v] = result_corner(1,2:4);
		c3_v = 0.1;
        l_e = subs(l_c,[c1,c2],[0,0]);
		solve_t123_c3
		Fvalue
        result_edge(1,:) = [F,t1_v,t2_v,t3_v,0,0,c3_v];
	end
else
    l0 = subs(l_c,[t1,t2,t3,c1,c2,c3],[t1_v,t2_v,x,0,0,result_corner(5,4)/x]);
	check_cinf
	if dFc_x>0
        [t1_v,t2_v,t3_v] = result_corner(5,2:4);
		t3_v = result_corner(5,4);
        l_e = subs(l_c,[c1,c2,c3],[0,0,result_corner(5,4)/t3]);
		solve_t123
		c3_v = result_corner(5,4)/t3_v;
		if c3_v<100
            c3_v = 0.9*c3_v;
            l_e = subs(l_c,[c1,c2],[0,0]);
			solve_t123_c3
...
if result_corner(2,1)>result_corner(6,1)
%if F_0_1_0>=F_0_1_1
    []
	t1_v = t1_0_1_0;
	t2_v = t2_0_1_0;
...
if F_0_1_1>=F_1_1_1
	...
	c3_v = 1;
	c1_v = t1_1_1_1/x;
    l0 = subs(l_c23,[t1,t2,t3,c1,c2,c3],[x,t2_v,t3_v,c1_v,1,1]);
	check_cinf
	if dFc_x>0
		t1_v = t1_1_1_1;
		c1_v = t1_1_1_1/t1;
        l_e = subs(l_c23,[c1,c2,c3],[c1_v,1,1]);
		solve_t123
		c1_v = t1_1_1_1/t1_v;
		if c1_v<100
            c1_v = 0.9*c1_v;
            l_e = subs(l_c23,[c2,c3],[1,1]);
			solve_t123_c1
		end
		Fvalue
		t1_c1_1_1 =t1_v;
...
%%%%%%%
if F_c1_0_0 ==max([F_c1_0_0,F_c1_0_1,F_c1_1_0,F_c1_1_1,F_0_c2_0,F_0_c2_1,F_1_c2_0,F_1_c2_1,F_0_0_c3,F_0_1_c3,F_1_0_c3,F_1_1_c3])
	F = F_c1_0_0;
